...
## Live Demo
- **Solution URL:** https://newsletter-sign-up-vite.netlify.app/

## Screenshot
![](preview.jpg)

A simple solution to the Frontend Mentor **Newsletter sign-up** challenge.
...
```bash
git clone https://github.com/hiticas/Newsletter-sign-up-vite.git
cd Newsletter-sign-up-vite
```
